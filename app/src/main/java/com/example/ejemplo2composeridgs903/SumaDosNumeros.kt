    ...
    Column(modifier = Modifier
        ...
        Button(onClick = {
            ...
            resultado = if (n1 != null && n2 != null){
                val res = when (operacion.trim()) {
                    "Suma" -> n1 + n2
                    "Resta" -> n1 - n2
                    "Multiplicacion" -> n1 * n2
                    "Division" -> if (n2 != 0) n1 / n2 else "División por cero"
    ...
    Column(
        ...
        radioOptions.forEach { text ->
            Row(
                ...
                RadioButton(
                    selected = (text == operacion),
                    onClick = null // controlado por Row
                )
                Text(
                    text = text,
